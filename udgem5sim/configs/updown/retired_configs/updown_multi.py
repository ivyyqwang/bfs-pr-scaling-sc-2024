...
create_mapping("configs/updown/updown.h",nlanes, 0x80000000, int(system.mem_ranges[0].end), UpMemorySize)
...
#   system.updown = UpstreamObj(latency=1,
#                              simdir=simdir,
#                              lm_mode=args.lm_mode,
#                              upmem_channels=args.upmem_channels,
#                              print_level=args.print_level,
...
if not(args.checkpoint_restore):
    for process in multiprocesses:
        if(args.progfile=='GenPagerankEFA'):
