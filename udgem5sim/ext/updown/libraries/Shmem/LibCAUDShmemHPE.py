...
@efaProgram
def LibCAUDShmemHPE(efa: EFAProgram):
    """
    ...
    shmem = CAUDShmem(efa, state0, event_map_start=0, debug_level=2, perflog_level=5, term_flag_offset=0, impl=CAUDShmem.implLocAwareFastSim, linker=True,
                      enableFastSim=True, # have to turn on fastsim to make it default
                      override_config=True,
                      numnodes=2, # number of nodes
                      blocksize=65536, # default blocksize in bytes, e.g. this is 64KB
