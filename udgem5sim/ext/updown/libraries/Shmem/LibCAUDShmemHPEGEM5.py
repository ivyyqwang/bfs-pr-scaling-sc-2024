...
@efaProgram
def LibCAUDShmemHPEGEM5(efa: EFAProgram):
    """
    Only work in GEM5 mode
    ...
    shmem = CAUDShmem(efa, state0, event_map_start=0, debug_level=2, perflog_level=5, term_flag_offset=0, impl=CAUDShmem.implLocAwareInterleaving, linker=True,
