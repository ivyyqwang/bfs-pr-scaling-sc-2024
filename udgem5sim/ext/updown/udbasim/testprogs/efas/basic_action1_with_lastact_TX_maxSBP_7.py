from EFA_v2 import *
def basic_action1_with_lastact_TX_maxSBP_7():
    efa = EFA([])
    ...
    tran0.writeAction("movir X16 36005")
    ...
    tran0.writeAction("movir X16 43548")
    ...
    tran0.writeAction("movrl X16 0(X17) 1 8")
    tran0.writeAction("movir X16 32378")
    ...
    tran0.writeAction("movrl X16 0(X17) 1 8")
    tran0.writeAction("movir X16 12435")
    ...
    tran2 = state2.writeTransition("basic_with_action", state2, state2, 145)
