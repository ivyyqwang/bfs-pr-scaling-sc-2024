from EFA_v2 import *
def basic_action1_with_lastact_TX_maxSBP_9():
    efa = EFA([])
    ...
    tran0.writeAction("movir X16 55871")
    ...
    tran0.writeAction("movir X16 46557")
    ...
    tran0.writeAction("movrl X16 0(X17) 1 8")
    tran0.writeAction("movir X16 24801")
