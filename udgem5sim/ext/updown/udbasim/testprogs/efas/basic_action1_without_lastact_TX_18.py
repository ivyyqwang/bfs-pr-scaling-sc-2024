from EFA_v2 import *
def basic_action1_without_lastact_TX_18():
    efa = EFA([])
    ...
    tran0.writeAction("movir X16 18051")
    ...
    tran0.writeAction("movir X16 680")
    ...
    tran0.writeAction("movrl X16 0(X17) 1 8")
    tran0.writeAction("movir X16 17232")
    ...
    tran0.writeAction("movrl X16 0(X17) 1 8")
    tran0.writeAction("movir X16 36051")
    ...
    tran0.writeAction("movrl X16 0(X17) 1 8")
    tran0.writeAction("movir X16 2207")
    ...
    tran2 = state2.writeTransition("basic_with_action", state2, state2, 63)
