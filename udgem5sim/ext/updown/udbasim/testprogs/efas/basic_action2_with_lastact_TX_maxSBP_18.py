from EFA_v2 import *
def basic_action2_with_lastact_TX_maxSBP_18():
    efa = EFA([])
    ...
    tran0.writeAction("movir X16 14024")
    ...
    tran0.writeAction("movir X16 15335")
    ...
    tran0.writeAction("movrl X16 0(X17) 1 8")
    tran0.writeAction("movir X16 21787")
    ...
    tran0.writeAction("movrl X16 0(X17) 1 8")
    tran0.writeAction("movir X16 14325")
    ...
    tran0.writeAction("movrl X16 0(X17) 1 8")
    tran0.writeAction("movir X16 63409")
    ...
    tran0.writeAction("movrl X16 0(X17) 1 8")
    tran0.writeAction("movir X16 45757")
    ...
    tran0.writeAction("movrl X16 0(X17) 1 8")
    tran0.writeAction("movir X16 64958")
    ...
    tran0.writeAction("movrl X16 0(X17) 1 8")
    tran0.writeAction("movir X16 40115")
    ...
    tran1 = state1.writeTransition("basic_with_action", state1, state2, 96)
    ...
    tran2 = state2.writeTransition("basic_with_action", state2, state2, 150)
