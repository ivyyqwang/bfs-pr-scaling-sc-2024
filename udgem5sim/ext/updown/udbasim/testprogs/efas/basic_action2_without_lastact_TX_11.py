from EFA_v2 import *
def basic_action2_without_lastact_TX_11():
    efa = EFA([])
    ...
    tran0.writeAction("movir X16 5318")
    ...
    tran0.writeAction("movrl X16 0(X17) 1 8")
    tran0.writeAction("movir X16 36118")
    ...
    tran0.writeAction("movrl X16 0(X17) 1 8")
    tran0.writeAction("movir X16 35430")
    ...
    tran0.writeAction("movrl X16 0(X17) 1 8")
    tran0.writeAction("movir X16 14931")
    ...
    tran0.writeAction("movrl X16 0(X17) 1 8")
    tran0.writeAction("movir X16 44640")
    ...
    tran2 = state2.writeTransition("basic_with_action", state2, state2, 186)
