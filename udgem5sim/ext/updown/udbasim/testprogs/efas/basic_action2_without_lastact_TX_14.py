from EFA_v2 import *
def basic_action2_without_lastact_TX_14():
    efa = EFA([])
    ...
    tran0.writeAction("movir X16 63742")
    ...
    tran0.writeAction("movrl X16 0(X17) 1 8")
    tran0.writeAction("movir X16 17194")
    ...
    tran0.writeAction("movrl X16 0(X17) 1 8")
    tran0.writeAction("movir X16 25063")
