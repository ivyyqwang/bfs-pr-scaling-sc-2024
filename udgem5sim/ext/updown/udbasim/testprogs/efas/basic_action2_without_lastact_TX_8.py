from EFA_v2 import *
def basic_action2_without_lastact_TX_8():
    efa = EFA([])
    ...
    tran0.writeAction("movir X16 64880")
    ...
    tran0.writeAction("movir X16 46708")
    ...
    tran0.writeAction("movrl X16 0(X17) 1 8")
    tran0.writeAction("movir X16 64096")
    ...
    tran0.writeAction("slorii X16 X16 12 3627")
    tran0.writeAction("movrl X16 0(X17) 1 8")
    tran0.writeAction("movir X16 54368")
    ...
    tran0.writeAction("movrl X16 0(X17) 1 8")
    tran0.writeAction("movir X16 3320")
