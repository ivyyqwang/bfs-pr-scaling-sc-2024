from EFA_v2 import *
def basic_action4_without_lastact_TX_13():
    efa = EFA([])
    ...
    tran0.writeAction("movir X16 61240")
    ...
    tran0.writeAction("movrl X16 0(X17) 1 8")
    tran0.writeAction("movir X16 9422")
    ...
    tran0.writeAction("movrl X16 0(X17) 1 8")
    tran0.writeAction("movir X16 40315")
    ...
    tran0.writeAction("slorii X16 X16 12 3216")
    tran0.writeAction("movrl X16 0(X17) 1 8")
    tran0.writeAction("movir X16 54175")
    ...
    tran2 = state2.writeTransition("basic_with_action", state2, state2, 109)
