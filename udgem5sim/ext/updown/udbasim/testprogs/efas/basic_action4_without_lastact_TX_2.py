from EFA_v2 import *
def basic_action4_without_lastact_TX_2():
    efa = EFA([])
    ...
    tran0.writeAction("movir X16 20819")
    ...
    tran0.writeAction("movir X16 65163")
    ...
    tran0.writeAction("movrl X16 0(X17) 1 8")
    tran0.writeAction("movir X16 14190")
    ...
    tran0.writeAction("movrl X16 0(X17) 1 8")
    tran0.writeAction("movir X16 52481")
    ...
    tran0.writeAction("movrl X16 0(X17) 1 8")
    tran0.writeAction("movir X16 47395")
