from EFA_v2 import *
def basic_action4_without_lastact_TX_3():
    efa = EFA([])
    ...
    tran0.writeAction("movir X16 41058")
    ...
    tran0.writeAction("movir X16 32814")
    ...
    tran0.writeAction("movrl X16 0(X17) 1 8")
    tran0.writeAction("movir X16 11508")
    ...
    tran0.writeAction("movrl X16 0(X17) 1 8")
    tran0.writeAction("movir X16 36438")
    ...
    tran0.writeAction("movrl X16 0(X17) 1 8")
    tran0.writeAction("movir X16 10346")
    ...
    tran0.writeAction("movrl X16 0(X17) 1 8")
    tran0.writeAction("movir X16 48155")
    ...
    tran0.writeAction("movrl X16 0(X17) 1 8")
    tran0.writeAction("movir X16 17369")
    ...
    tran0.writeAction("movrl X16 0(X17) 1 8")
    tran0.writeAction("movir X16 51247")
    ...
    tran1 = state1.writeTransition("basic_with_action", state1, state2, 108)
