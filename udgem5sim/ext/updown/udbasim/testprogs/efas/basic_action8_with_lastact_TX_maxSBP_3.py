from EFA_v2 import *
def basic_action8_with_lastact_TX_maxSBP_3():
    efa = EFA([])
    ...
    tran0.writeAction("movir X16 26784")
    ...
    tran0.writeAction("movir X16 57313")
    ...
    tran0.writeAction("movrl X16 0(X17) 1 8")
    tran0.writeAction("movir X16 10321")
    ...
    tran0.writeAction("movrl X16 0(X17) 1 8")
    tran0.writeAction("movir X16 32071")
    ...
    tran0.writeAction("movrl X16 0(X17) 1 8")
    tran0.writeAction("movir X16 60455")
    ...
    tran2 = state2.writeTransition("basic_with_action", state2, state2, 47)
