from EFA_v2 import *
def basic_action8_with_lastact_TX_maxSBP_6():
    efa = EFA([])
    ...
    tran0.writeAction("movrl X16 0(X17) 1 8")
    tran0.writeAction("movir X16 7695")
    ...
    tran0.writeAction("movrl X16 0(X17) 1 8")
    tran0.writeAction("movir X16 45377")
    ...
    tran0.writeAction("movrl X16 0(X17) 1 8")
    tran0.writeAction("movir X16 56950")
    ...
    tran0.writeAction("movrl X16 0(X17) 1 8")
    tran0.writeAction("movir X16 23411")
    ...
    tran2 = state2.writeTransition("basic_with_action", state2, state2, 113)
