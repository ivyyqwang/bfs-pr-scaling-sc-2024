from EFA_v2 import *
def basic_action8_with_lastact_TX_maxSBP_8():
    efa = EFA([])
    ...
    tran0.writeAction("movrl X16 0(X17) 1 8")
    tran0.writeAction("movir X16 38597")
    ...
    tran0.writeAction("movrl X16 0(X17) 1 8")
    tran0.writeAction("movir X16 18586")
    ...
    tran0.writeAction("movrl X16 0(X17) 1 8")
    tran0.writeAction("movir X16 61432")
    ...
    tran0.writeAction("movrl X16 0(X17) 1 8")
    tran0.writeAction("movir X16 19954")
    ...
    tran0.writeAction("movrl X16 0(X17) 1 8")
    tran0.writeAction("movir X16 24387")
    ...
    tran0.writeAction("movrl X16 0(X17) 1 8")
    tran0.writeAction("movir X16 39495")
    ...
    tran1 = state1.writeTransition("basic_with_action", state1, state2, 227)
    ...
    tran2 = state2.writeTransition("basic_with_action", state2, state2, 226)
