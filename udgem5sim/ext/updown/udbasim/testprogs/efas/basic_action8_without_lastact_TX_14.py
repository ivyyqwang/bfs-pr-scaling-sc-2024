from EFA_v2 import *
def basic_action8_without_lastact_TX_14():
    efa = EFA([])
    ...
    tran0.writeAction("movir X16 44897")
    ...
    tran0.writeAction("movrl X16 0(X17) 1 8")
    tran0.writeAction("movir X16 31674")
    ...
    tran0.writeAction("movrl X16 0(X17) 1 8")
    tran0.writeAction("movir X16 35812")
    ...
    tran0.writeAction("movrl X16 0(X17) 1 8")
    tran0.writeAction("movir X16 50086")
    ...
    tran1 = state1.writeTransition("basic_with_action", state1, state2, 42)
