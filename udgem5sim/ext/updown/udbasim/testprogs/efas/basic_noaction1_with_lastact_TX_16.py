from EFA_v2 import *
def basic_noaction1_with_lastact_TX_16():
    efa = EFA([])
    ...
    tran0.writeAction("movir X16 59108")
    ...
    tran0.writeAction("movir X16 39455")
    ...
    tran0.writeAction("movrl X16 0(X17) 1 8")
    tran0.writeAction("movir X16 52641")
    ...
    tran0.writeAction("movrl X16 0(X17) 1 8")
    tran0.writeAction("movir X16 52785")
    ...
    tran1 = state1.writeTransition("basic", state1, state2, 23)
    tran3 = state1.writeTransition("basic_with_action", state1, state2, 255)
    tran3.writeAction("movir X30 8")
    tran3.writeAction("lastact")
    tran2 = state2.writeTransition("basic_with_action", state2, state2, 30)
