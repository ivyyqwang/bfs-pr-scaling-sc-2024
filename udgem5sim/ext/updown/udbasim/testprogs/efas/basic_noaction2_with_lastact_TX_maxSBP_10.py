from EFA_v2 import *
def basic_noaction2_with_lastact_TX_maxSBP_10():
    efa = EFA([])
    ...
    tran0.writeAction("movir X16 16255")
    ...
    tran0.writeAction("movir X16 35967")
    ...
    tran0.writeAction("movrl X16 0(X17) 1 8")
    tran0.writeAction("movir X16 28410")
    ...
    tran0.writeAction("movrl X16 0(X17) 1 8")
    tran0.writeAction("movir X16 40990")
    ...
    tran0.writeAction("movrl X16 0(X17) 1 8")
    tran0.writeAction("movir X16 49444")
    ...
    tran0.writeAction("movrl X16 0(X17) 1 8")
    tran0.writeAction("movir X16 42296")
    ...
    tran0.writeAction("movrl X16 0(X17) 1 8")
    tran0.writeAction("movir X16 32901")
    ...
    tran0.writeAction("movrl X16 0(X17) 1 8")
    tran0.writeAction("movir X16 64671")
    ...
    tran1 = state1.writeTransition("basic", state1, state2, 89)
    tran3 = state1.writeTransition("basic_with_action", state1, state2, 255)
    tran3.writeAction("addi X5 X16 0")
    tran3.writeAction("movir X30 8")
    tran3.writeAction("lastact")
    tran2 = state2.writeTransition("basic", state2, state2, 63)
