from EFA_v2 import *
def basic_noaction2_with_lastact_TX_maxSBP_17():
    efa = EFA([])
    ...
    tran0.writeAction("movir X16 53664")
    ...
    tran0.writeAction("movrl X16 0(X17) 1 8")
    tran0.writeAction("movir X16 46554")
    ...
    tran0.writeAction("movrl X16 0(X17) 1 8")
    tran0.writeAction("movir X16 19888")
    ...
    tran0.writeAction("movrl X16 0(X17) 1 8")
    tran0.writeAction("movir X16 56569")
    ...
    tran2 = state2.writeTransition("basic", state2, state2, 172)
