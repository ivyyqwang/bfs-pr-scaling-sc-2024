from EFA_v2 import *
def basic_noaction4_with_lastact_TX_19():
    efa = EFA([])
    ...
    tran0.writeAction("movrl X16 0(X17) 1 8")
    tran0.writeAction("movir X16 16535")
    ...
    tran0.writeAction("movrl X16 0(X17) 1 8")
    tran0.writeAction("movir X16 49516")
    ...
    tran0.writeAction("movrl X16 0(X17) 1 8")
    tran0.writeAction("movir X16 56795")
    ...
    tran0.writeAction("movrl X16 0(X17) 1 8")
    tran0.writeAction("movir X16 63623")
    ...
    tran1 = state1.writeTransition("basic", state1, state2, 147)
    ...
    tran2 = state2.writeTransition("basic_with_action", state2, state2, 115)
