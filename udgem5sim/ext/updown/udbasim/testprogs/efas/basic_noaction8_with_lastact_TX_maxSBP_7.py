from EFA_v2 import *
def basic_noaction8_with_lastact_TX_maxSBP_7():
    efa = EFA([])
    ...
    tran0.writeAction("movir X16 36458")
    ...
    tran0.writeAction("movir X16 10748")
    ...
    tran0.writeAction("movrl X16 0(X17) 1 8")
    tran0.writeAction("movir X16 58074")
    ...
    tran0.writeAction("movrl X16 0(X17) 1 8")
    tran0.writeAction("movir X16 35007")
