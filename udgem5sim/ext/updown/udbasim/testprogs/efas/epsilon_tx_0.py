...
def epsilon_tx_0():
    ...
    tran = state.writeTransition("epsilonCarry_with_action", state, state0, 1)
    ...
    tran = state1.writeTransition("commonCarry_with_action", state1, state1, 0)
    tran.writeAction("movir X17 2")   #(mov_imm2reg) 
