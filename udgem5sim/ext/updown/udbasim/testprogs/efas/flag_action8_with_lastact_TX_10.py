from EFA_v2 import *
def flag_action8_with_lastact_TX_10():
    efa = EFA([])
    ...
    tran0.writeAction("movir X16 57251")
    ...
    tran0.writeAction("movir X16 12844")
    ...
    tran0.writeAction("movrl X16 0(X17) 1 8")
    tran0.writeAction("movir X16 1962")
    ...
    tran0.writeAction("movrl X16 0(X17) 1 8")
    tran0.writeAction("movir X16 43141")
    ...
    tran0.writeAction("movrl X16 0(X17) 1 8")
    tran0.writeAction("movir X16 29057")
    ...
    tran1 = state1.writeTransition("flagCarry_with_action", state1, state2, 103)
    tran1.writeAction("movir X16 77")
    ...
    tran2 = state2.writeTransition("flagCarry_with_action", state2, state2, 77)
