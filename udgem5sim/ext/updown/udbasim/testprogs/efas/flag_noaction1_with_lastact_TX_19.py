from EFA_v2 import *
def flag_noaction1_with_lastact_TX_19():
    efa = EFA([])
    ...
    tran0.writeAction("movir X16 36204")
    ...
    tran0.writeAction("movir X16 56857")
    ...
    tran0.writeAction("movrl X16 0(X17) 1 8")
    tran0.writeAction("movir X16 11965")
    ...
    tran0.writeAction("movrl X16 0(X17) 1 8")
    tran0.writeAction("movir X16 22404")
    ...
    tran0.writeAction("movrl X16 0(X17) 1 8")
    tran0.writeAction("movir X16 39419")
    ...
    tran0.writeAction("movir X31 0")
    tran0.writeAction("movir X16 244")
    tran0.writeAction("lastact")
    tran1 = state1.writeTransition("flagCarry", state1, state2, 244)
    tran3 = state1.writeTransition("flagCarry_with_action", state1, state2, 255)
    tran3.writeAction("movir X16 255")
    tran3.writeAction("lastact")
    tran2 = state2.writeTransition("flagCarry_with_action", state2, state2, 244)
