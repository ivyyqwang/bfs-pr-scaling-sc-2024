...
def refill_0_common_TX():
    ...
    tran0.writeAction("movir X16 54102")
    ...
    tran1.writeAction("movir X16 58922")
    tran1.writeAction("slorii X16 X16 12 3090")
    tran1.writeAction("slorii X16 X16 12 3947")
    tran1.writeAction("slorii X16 X16 12 974")
    tran1.writeAction("slorii X16 X16 12 1177")
    tran1.writeAction("movir X17 0")
    tran1.writeAction("add X16 X17 X5")
    tran1.writeAction("refill 7110")
