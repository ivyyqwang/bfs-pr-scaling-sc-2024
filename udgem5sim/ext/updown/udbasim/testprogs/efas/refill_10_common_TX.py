...
def refill_10_common_TX():
    ...
    tran0.writeAction("movir X16 35656")
    ...
    tran1.writeAction("movir X16 42516")
    tran1.writeAction("slorii X16 X16 12 2262")
    tran1.writeAction("slorii X16 X16 12 2042")
    tran1.writeAction("slorii X16 X16 12 2253")
    tran1.writeAction("slorii X16 X16 12 1493")
    tran1.writeAction("movir X17 0")
    tran1.writeAction("add X16 X17 X5")
    tran1.writeAction("refill 11243")
