...
def refill_11_common_TX():
    ...
    tran0.writeAction("movir X16 39296")
    ...
    tran1.writeAction("movir X16 48677")
    tran1.writeAction("slorii X16 X16 12 2870")
    tran1.writeAction("slorii X16 X16 12 1665")
    tran1.writeAction("slorii X16 X16 12 1462")
    tran1.writeAction("slorii X16 X16 12 3176")
    tran1.writeAction("movir X17 0")
    tran1.writeAction("add X16 X17 X5")
    tran1.writeAction("refill 37532")
