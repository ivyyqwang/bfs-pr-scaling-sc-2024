...
def refill_12_common_TX():
    ...
    tran0.writeAction("movir X16 19945")
    ...
    tran1.writeAction("movir X16 2314")
    tran1.writeAction("slorii X16 X16 12 1767")
    tran1.writeAction("slorii X16 X16 12 1052")
    tran1.writeAction("slorii X16 X16 12 3096")
    tran1.writeAction("slorii X16 X16 12 887")
    tran1.writeAction("movir X17 0")
    tran1.writeAction("add X16 X17 X5")
    tran1.writeAction("refill 852")
