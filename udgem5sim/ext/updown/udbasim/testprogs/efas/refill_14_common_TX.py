...
def refill_14_common_TX():
    ...
    tran0.writeAction("movir X16 39469")
    ...
    tran1.writeAction("movir X16 60129")
    tran1.writeAction("slorii X16 X16 12 3672")
    tran1.writeAction("slorii X16 X16 12 3073")
    tran1.writeAction("slorii X16 X16 12 3121")
    tran1.writeAction("slorii X16 X16 12 3492")
    tran1.writeAction("movir X17 0")
    tran1.writeAction("add X16 X17 X5")
    tran1.writeAction("refill 53406")
