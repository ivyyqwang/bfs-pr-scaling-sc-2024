...
def refill_15_common_TX():
    ...
    tran1.writeAction("movir X16 51288")
    tran1.writeAction("slorii X16 X16 12 3718")
    tran1.writeAction("slorii X16 X16 12 73")
    tran1.writeAction("slorii X16 X16 12 3155")
    tran1.writeAction("slorii X16 X16 12 407")
    tran1.writeAction("movir X17 0")
    tran1.writeAction("add X16 X17 X5")
    tran1.writeAction("refill 44338")
