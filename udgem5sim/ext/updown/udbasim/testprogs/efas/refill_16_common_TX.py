...
def refill_16_common_TX():
    ...
    tran0.writeAction("movir X16 26967")
    ...
    tran1.writeAction("movir X16 5442")
    tran1.writeAction("slorii X16 X16 12 1704")
    tran1.writeAction("slorii X16 X16 12 2433")
    tran1.writeAction("slorii X16 X16 12 3522")
    tran1.writeAction("slorii X16 X16 12 3658")
    tran1.writeAction("movir X17 0")
    tran1.writeAction("add X16 X17 X5")
    tran1.writeAction("refill 61170")
