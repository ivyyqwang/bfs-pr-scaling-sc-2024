...
def refill_17_common_TX():
    ...
    tran0.writeAction("movir X16 36439")
    ...
    tran1.writeAction("movir X16 11707")
    tran1.writeAction("slorii X16 X16 12 3777")
    tran1.writeAction("slorii X16 X16 12 1900")
    tran1.writeAction("slorii X16 X16 12 2393")
    tran1.writeAction("slorii X16 X16 12 2330")
    tran1.writeAction("movir X17 0")
    tran1.writeAction("add X16 X17 X5")
    tran1.writeAction("refill 21641")
