...
def refill_18_common_TX():
    ...
    tran0.writeAction("movir X16 7055")
    ...
    tran1.writeAction("movir X16 45218")
    tran1.writeAction("slorii X16 X16 12 3811")
    tran1.writeAction("slorii X16 X16 12 630")
    tran1.writeAction("slorii X16 X16 12 1612")
    tran1.writeAction("slorii X16 X16 12 456")
    tran1.writeAction("movir X17 0")
    tran1.writeAction("add X16 X17 X5")
    tran1.writeAction("refill 11849")
