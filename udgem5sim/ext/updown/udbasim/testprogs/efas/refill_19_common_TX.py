...
def refill_19_common_TX():
    ...
    tran0.writeAction("movir X16 1058")
    ...
    tran1.writeAction("movir X16 59573")
    tran1.writeAction("slorii X16 X16 12 1066")
    tran1.writeAction("slorii X16 X16 12 434")
    tran1.writeAction("slorii X16 X16 12 2047")
    tran1.writeAction("slorii X16 X16 12 2256")
    tran1.writeAction("movir X17 0")
    tran1.writeAction("add X16 X17 X5")
    tran1.writeAction("refill 703")
