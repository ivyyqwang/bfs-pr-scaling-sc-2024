...
def refill_1_common_TX():
    ...
    tran0.writeAction("movir X16 9669")
    ...
    tran1.writeAction("movir X16 53510")
    tran1.writeAction("slorii X16 X16 12 3682")
    tran1.writeAction("slorii X16 X16 12 2100")
    tran1.writeAction("slorii X16 X16 12 374")
    tran1.writeAction("slorii X16 X16 12 2331")
    tran1.writeAction("movir X17 0")
    tran1.writeAction("add X16 X17 X5")
    tran1.writeAction("refill 50502")
