...
def refill_2_common_TX():
    ...
    tran0.writeAction("movir X16 8922")
    ...
    tran1.writeAction("movir X16 29316")
    tran1.writeAction("slorii X16 X16 12 1608")
    tran1.writeAction("slorii X16 X16 12 2472")
    tran1.writeAction("slorii X16 X16 12 858")
    tran1.writeAction("slorii X16 X16 12 2303")
    tran1.writeAction("movir X17 0")
    tran1.writeAction("add X16 X17 X5")
    tran1.writeAction("refill 43218")
