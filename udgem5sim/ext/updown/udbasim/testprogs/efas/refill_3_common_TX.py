...
def refill_3_common_TX():
    ...
    tran1.writeAction("movir X16 61344")
    tran1.writeAction("slorii X16 X16 12 2640")
    tran1.writeAction("slorii X16 X16 12 81")
    tran1.writeAction("slorii X16 X16 12 449")
    tran1.writeAction("slorii X16 X16 12 187")
    tran1.writeAction("movir X17 0")
    tran1.writeAction("add X16 X17 X5")
    tran1.writeAction("refill 57374")
