...
def refill_4_common_TX():
    ...
    tran1.writeAction("movir X16 10747")
    tran1.writeAction("slorii X16 X16 12 1361")
    tran1.writeAction("slorii X16 X16 12 3095")
    tran1.writeAction("slorii X16 X16 12 2151")
    tran1.writeAction("slorii X16 X16 12 3339")
    tran1.writeAction("movir X17 0")
    tran1.writeAction("add X16 X17 X5")
    tran1.writeAction("refill 43632")
