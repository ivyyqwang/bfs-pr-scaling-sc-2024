...
def refill_5_common_TX():
    ...
    tran0.writeAction("movir X16 7705")
    ...
    tran1.writeAction("movir X16 14256")
    tran1.writeAction("slorii X16 X16 12 3159")
    tran1.writeAction("slorii X16 X16 12 3014")
    tran1.writeAction("slorii X16 X16 12 2973")
    tran1.writeAction("slorii X16 X16 12 3572")
    tran1.writeAction("movir X17 0")
    tran1.writeAction("add X16 X17 X5")
    tran1.writeAction("refill 55322")
