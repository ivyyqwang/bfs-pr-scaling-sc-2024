...
def refill_6_common_TX():
    ...
    tran0.writeAction("movir X16 14323")
    ...
    tran1.writeAction("movir X16 50072")
    tran1.writeAction("slorii X16 X16 12 1612")
    tran1.writeAction("slorii X16 X16 12 1465")
    tran1.writeAction("slorii X16 X16 12 3410")
    tran1.writeAction("slorii X16 X16 12 3250")
    tran1.writeAction("movir X17 0")
    tran1.writeAction("add X16 X17 X5")
    tran1.writeAction("refill 59166")
