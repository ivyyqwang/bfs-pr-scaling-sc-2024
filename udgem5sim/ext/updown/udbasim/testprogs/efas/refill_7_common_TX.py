...
def refill_7_common_TX():
    ...
    tran0.writeAction("movir X16 34488")
    ...
    tran1.writeAction("movir X16 34164")
    tran1.writeAction("slorii X16 X16 12 1136")
    tran1.writeAction("slorii X16 X16 12 1464")
    tran1.writeAction("slorii X16 X16 12 2335")
    tran1.writeAction("slorii X16 X16 12 87")
    tran1.writeAction("movir X17 0")
    tran1.writeAction("add X16 X17 X5")
    tran1.writeAction("refill 53379")
