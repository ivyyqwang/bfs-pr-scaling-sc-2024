...
def refill_8_common_TX():
    ...
    tran0.writeAction("movir X16 36174")
    ...
    tran1.writeAction("movir X16 59571")
    tran1.writeAction("slorii X16 X16 12 1702")
    tran1.writeAction("slorii X16 X16 12 1886")
    tran1.writeAction("slorii X16 X16 12 752")
    tran1.writeAction("slorii X16 X16 12 1947")
    tran1.writeAction("movir X17 0")
    tran1.writeAction("add X16 X17 X5")
    tran1.writeAction("refill 53494")
