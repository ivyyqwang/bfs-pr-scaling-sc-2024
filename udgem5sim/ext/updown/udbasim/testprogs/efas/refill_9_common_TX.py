...
def refill_9_common_TX():
    ...
    tran0.writeAction("movir X16 34127")
    ...
    tran1.writeAction("movir X16 25166")
    tran1.writeAction("slorii X16 X16 12 1703")
    tran1.writeAction("slorii X16 X16 12 2610")
    tran1.writeAction("slorii X16 X16 12 1011")
    tran1.writeAction("slorii X16 X16 12 3160")
    tran1.writeAction("movir X17 0")
    tran1.writeAction("add X16 X17 X5")
    tran1.writeAction("refill 32130")
