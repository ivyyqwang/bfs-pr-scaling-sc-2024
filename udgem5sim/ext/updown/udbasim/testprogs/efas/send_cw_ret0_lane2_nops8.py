...
def send_cw_ret0_lane2_nops8():
    ...
    # mode1==0, send_wret, Xc is the cont_word
    tran0.writeAction("evi X2 X25 2 1")

    # may or maynot write to SP
    tran0.writeAction("movir X24 0") # reset Xptr
    tran0.writeAction("add X7 X18 X24")
    tran0.writeAction("movrl X8 0(X24) 1 8")
    tran0.writeAction("movrl X9 0(X24) 1 8")
    tran0.writeAction("movrl X10 0(X24) 1 8")
    tran0.writeAction("movrl X11 0(X24) 1 8")
    tran0.writeAction("movrl X12 0(X24) 1 8")
    tran0.writeAction("movrl X13 0(X24) 1 8")
    tran0.writeAction("movrl X14 0(X24) 1 8")
    tran0.writeAction("movrl X15 0(X24) 1 8")
    
    tran0.writeAction("movir X24 0") # reset Xptr after send
    tran0.writeAction("add X7 X18 X24")
    tran0.writeAction("movir X24 0") # reset Xptr
    tran0.writeAction("add X7 X18 X24")
    tran0.writeAction("movrl X8 0(X24) 1 8")
    ...
    tran0.writeAction("evi X31 X31 1 8")
    tran0.writeAction("send X31 X25 X24 8 0")
    ...
    tran0.writeAction("movir X30 1") # set flag to 1
    tran0.writeAction("addi X7 X24 0") # starting from base
    tran0.writeAction("movrl X30 0(X24) 0 8") # write flag the beginning of the SP
    tran0.writeAction("yieldt") # for sure e1 will term
    ...
    tran1.writeAction("movrl X13 0(X24) 1 8")
    tran1.writeAction("movrl X14 0(X24) 1 8")
    tran1.writeAction("movrl X15 0(X24) 1 8")
