...
from EFA_v2 import *
def sendm_cw_ret0_lane1_nops8_load():
    efa = EFA([])
    ...
    tran0.writeAction("sendm X17 X25 X24 8 0")
    ...
    # Xptr is reset to 8, for sendm write_return, static address starting from 8
    tran3.writeAction("add X7 X24 X24")
    tran3.writeAction("movrl X8 0(X24) 1 8")
    tran3.writeAction("movrl X9 0(X24) 1 8")
    tran3.writeAction("movrl X10 0(X24) 1 8")
    tran3.writeAction("movrl X11 0(X24) 1 8")
    tran3.writeAction("movrl X12 0(X24) 1 8")
    tran3.writeAction("movrl X13 0(X24) 1 8")
    tran3.writeAction("movrl X14 0(X24) 1 8")
    tran3.writeAction("movrl X15 0(X24) 1 8")
