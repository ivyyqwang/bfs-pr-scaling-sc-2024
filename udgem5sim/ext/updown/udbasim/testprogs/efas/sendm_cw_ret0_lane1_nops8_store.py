...
from EFA_v2 import *
def sendm_cw_ret0_lane1_nops8_store():
    efa = EFA([])
    ...
    tran0.writeAction("evi X2 X25 3 1") #sendm with contword
    ...
    tran0.writeAction("evi X25 X25 0 8") # new lid update lid with lc.value
    tran0.writeAction("evi X25 X25 255 4") # new thread, cont_label will handle sendm*_wret 
    tran0.writeAction("sendm X17 X25 X24 8 1")
