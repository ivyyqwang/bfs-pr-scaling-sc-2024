...
def dram_tests(CHUNK_SIZE=8):
    ...
    # launch_parent
        ...
        tran0.writeAction(f"sendr_wret {EVW} {event_map['child_join']} {WIDX} {TID} {NELEMS_PER_THREAD}")
    ...
    def dram_read_CHUNK_SIZE(CHUNK_SIZE=8):
        ...
        tran2.writeAction(f"send_dmlm_ld_wret {RPTR} {event_map[f'dram_read_{CHUNK_SIZE}_return']} {CHUNK_SIZE}") 
    ...
    def dram_read_CHUNK_SIZE_return(CHUNK_SIZE=8):
        ...
        tran.writeAction(f"sendops_dmlm_wret {STPTR} {event_map[f'dram_write_{CHUNK_SIZE}_ack']} X8 {CHUNK_SIZE}") # sendm_wret
    ...
    def dram_write_CHUNK_SIZE_ack(CHUNK_SIZE=8):
        ...
        tran.writeAction(f"yield")
        tran.writeAction(f"write_done: sendr_reply {WIDX} {WIDX} {WIDX}")
