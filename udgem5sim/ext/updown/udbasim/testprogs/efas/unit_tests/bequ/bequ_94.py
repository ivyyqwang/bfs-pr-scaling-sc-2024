...
def bequ_94():
    ...
    tran0.writeAction('movir X16 1330483')
    tran0.writeAction('movir X17 1330483')
    tran0.writeAction('movir X18 1862067')
    tran0.writeAction('movir X19 0')
    tran0.writeAction('movir X20 0')
    tran0.writeAction('bequ X16 X17 expect_true')
    tran0.writeAction('jmp false_test')
    tran0.writeAction('expect_true: movir X19 1')
    tran0.writeAction('false_test: bequ X16 X18 save')
