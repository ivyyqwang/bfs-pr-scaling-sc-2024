...
def bgtiu():
    ...
    return parse_instructions([
        f'movir {x1} 7',
        f'bgtiu {op} 7 pass0', # test reading op
        f'jmp fail', # should never run
        f'loop2: movir {x1} 6', 
        f'pass0: bgtiu {x1} 6 loop2',#test reverse transversal

        unsigned_max_reg(x1),
        branch_to(unsigned_max_5,'pass9'),
        unsigned_max_reg(x1, 'pass9: '),
        branch_to(signed_max_5,'pass1'),
        ...
        branch_to(signed_max_5,'pass4'),
        signed_max_reg(x1,'pass4: '),
        branch_to(unsigned_min,'pass5'),
        signed_max_reg(x1,'pass5: '),
        branch_to(signed_min_5,'pass6'),
        ...
        branch_to(signed_max_5,'pass7'),
        signed_min_reg(x1,'pass7: '),
        branch_to(unsigned_min,'pass8'),
