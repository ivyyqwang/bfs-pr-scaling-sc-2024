...
def ble_16():
    ...
    tran0.writeAction('movir X16 -1013016')
    tran0.writeAction('movir X17 386920')
    tran0.writeAction('movir X18 -1042544')
    tran0.writeAction('movir X19 0')
    tran0.writeAction('movir X20 0')
    tran0.writeAction('ble X16 X17 expect_true')
    tran0.writeAction('jmp false_test')
    tran0.writeAction('expect_true: movir X19 1')
    tran0.writeAction('false_test: ble X16 X18 save')
