...
def bne_91():
    ...
    tran0.writeAction('movir X16 1003036')
    tran0.writeAction('movir X17 361329')
    tran0.writeAction('movir X18 1003036')
    tran0.writeAction('movir X19 0')
    tran0.writeAction('movir X20 0')
    tran0.writeAction('bne X16 X17 expect_true')
    tran0.writeAction('jmp false_test')
    tran0.writeAction('expect_true: movir X19 1')
    tran0.writeAction('false_test: bne X16 X18 save')
