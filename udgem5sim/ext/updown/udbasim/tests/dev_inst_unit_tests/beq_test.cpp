...
TEST_F(Beq, Random) {
  ...
  inst = constrInstBneBeqBgtBle(1, RegId::X16, RegId::X17, target & BF_BEQ_TARGETA_MASK, (target >> BF_BEQ_TARGETA_NBITS) & BF_BEQ_TARGETB_MASK);
