...
TEST_F(Beqi, Random) {
  ...
  inst = constrInstBneiBeqiBgtiBleiBltiBgei(1, RegId::X16, v2, target & BF_BEQI_TARGETA_MASK, (target >> BF_BEQI_TARGETA_NBITS) & BF_BEQI_TARGETB_MASK);
