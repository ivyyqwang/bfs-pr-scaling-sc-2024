...
TEST_F(Bequ, Random) {
  ...
  inst = constrInstBneuBequBgtuBleu(1, RegId::X16, RegId::X17, target & BF_BEQU_TARGETA_MASK, (target >> BF_BEQU_TARGETA_NBITS) & BF_BEQU_TARGETB_MASK);
