...
class Bgei : public ::testing::Test {
protected:
  // Setup arch state
  // push data
...
TEST_F(Bgei, Random) {
  ...
  inst = constrInstBneiBeqiBgtiBleiBltiBgei(5, RegId::X16, v2, target & BF_BGTI_TARGETA_MASK, (target >> BF_BGTI_TARGETA_NBITS) & BF_BGTI_TARGETB_MASK);
