...
TEST_F(Bgtiu, Random) {
  ...
  inst = constrInstBneiuBeqiuBgtiuBleiuBltiuBgeiu(2, RegId::X16, v2, target & BF_BGTIU_TARGETA_MASK, (target >> BF_BGTIU_TARGETA_NBITS) & BF_BGTIU_TARGETB_MASK);
