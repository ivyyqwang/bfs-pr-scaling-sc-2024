...
TEST_F(Bgtu, Random) {
  ...
  inst = constrInstBneuBequBgtuBleu(2, RegId::X16, RegId::X17, target & BF_BGTU_TARGETA_MASK, (target >> BF_BGTU_TARGETA_NBITS) & BF_BGTU_TARGETB_MASK);
