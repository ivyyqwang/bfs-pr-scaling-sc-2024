...
TEST_F(Ble, Random) {
  ...
  inst = constrInstBneBeqBgtBle(3, RegId::X16, RegId::X17, target & BF_BLE_TARGETA_MASK, (target >> BF_BLE_TARGETA_NBITS) & BF_BLE_TARGETB_MASK);
