...
TEST_F(Bleiu, Random) {
  ...
  inst = constrInstBneiuBeqiuBgtiuBleiuBltiuBgeiu(3, RegId::X16, v2, target & BF_BLEIU_TARGETA_MASK, (target >> BF_BLEIU_TARGETA_NBITS) & BF_BLEIU_TARGETB_MASK);
