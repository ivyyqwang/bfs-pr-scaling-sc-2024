...
class Bleu : public ::testing::Test {
protected:
  // Setup arch state
  // push data
...
TEST_F(Bleu, Random) {
  ...
  inst = constrInstBneuBequBgtuBleu(3, RegId::X16, RegId::X17, target & BF_BLEU_TARGETA_MASK, (target >> BF_BLEU_TARGETA_NBITS) & BF_BLEU_TARGETB_MASK);
