...
TEST_F(Blti, Random) {
  ...
  inst = constrInstBneiBeqiBgtiBleiBltiBgei(4, RegId::X16, v2, target & BF_BLTI_TARGETA_MASK, (target >> BF_BLTI_TARGETA_NBITS) & BF_BLTI_TARGETB_MASK);
