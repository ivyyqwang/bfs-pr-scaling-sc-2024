...
TEST_F(Bne, Random) {
  ...
  inst = constrInstBneBeqBgtBle(0, RegId::X16, RegId::X17, target & BF_BNE_TARGETA_MASK, (target >> BF_BNE_TARGETA_NBITS) & BF_BNE_TARGETB_MASK);
