...
TEST_F(Bnei, Random) {
  ...
  inst = constrInstBneiBeqiBgtiBleiBltiBgei(0, RegId::X16, v2, target & BF_BNEI_TARGETA_MASK, (target >> BF_BNEI_TARGETA_NBITS) & BF_BNEI_TARGETB_MASK);
...
TEST_F(Bnei, NotTaken) {
  ...
  std::mt19937_64 rnd(std::random_device{}());
  int64_t v1 = 10;
  int64_t v2 = static_cast<int64_t>((10 & 0x1F));
