...
TEST_F(Bneiu, Random) {
  ...
  inst = constrInstBneiuBeqiuBgtiuBleiuBltiuBgeiu(0, RegId::X16, v2, target & BF_BNEIU_TARGETA_MASK, (target >> BF_BNEIU_TARGETA_NBITS) & BF_BNEIU_TARGETB_MASK);
...
TEST_F(Bneiu, Taken) {
  ...
  std::mt19937_64 rnd(std::random_device{}());
  uint64_t v1 = 25;
  uint64_t v2 = static_cast<int64_t>((24 & 0x1F));
...
TEST_F(Bneiu, NotTaken) {
  ...
  std::mt19937_64 rnd(std::random_device{}());
  uint64_t v1 = 10;
  uint64_t v2 = static_cast<int64_t>((10 & 0x1F));
