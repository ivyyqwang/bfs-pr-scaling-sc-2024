...
class Fcnvt_32_64 : public ::testing::Test {
protected:
  // Setup arch state
  // push data
...
TEST_F(Fcnvt_32_64, Random) {
  ...
  inst = constrInstFcnvt(1, 2, RegId::X16, RegId::X17);
...
TEST_F(Fcnvt_32_64, Edge0) {
  ...
  uint64_t v2 = rnd();
  uint64_t v3 = 0x36A0000000000000;
...
TEST_F(Fcnvt_32_64, Edge1) {
  ...
  uint64_t v2 = rnd();
  uint64_t v3 = 0xB6A0000000000000;
...
TEST_F(Fcnvt_32_64, Edge4) {
  ...
  uint64_t v2 = rnd();
  uint64_t v3 = 0x7FFFFFFFE0000000;
...
TEST_F(Fcnvt_32_64, Edge5) {
  ...
  uint64_t v2 = rnd();
  uint64_t v3 = 0xFFFFFFFFE0000000;
