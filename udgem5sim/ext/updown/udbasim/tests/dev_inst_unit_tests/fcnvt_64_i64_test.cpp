...
class Fcnvt_64_i64 : public ::testing::Test {
protected:
  // Setup arch state
  // push data
...
TEST_F(Fcnvt_64_i64, Random) {
  ...
  uint64_t v1 = 0x430B500000000000;
  uint64_t v2 = rnd();
  uint64_t v3 = 0x00036A0000000000;

  inst = constrInstFcnvt(0, 1, RegId::X16, RegId::X17);
...
TEST_F(Fcnvt_64_i64, Edge2) {
  ...
  std::mt19937_64 rnd(std::random_device{}());
  uint64_t v1 = 0x7FEFFFFFFFFFFFFF;
  uint64_t v2 = rnd();
...
TEST_F(Fcnvt_64_i64, Edge3) {
  ...
  std::mt19937_64 rnd(std::random_device{}());
  uint64_t v1 = 0xFFEFFFFFFFFFFFFF;
  uint64_t v2 = rnd();
  uint64_t v3 = 0x8000000000000000;
