...
class Fcnvt_b16_32 : public ::testing::Test {
protected:
  // Setup arch state
  // push data
...
TEST_F(Fcnvt_b16_32, Random) {
  ...
  inst = constrInstFcnvt(2, 3, RegId::X16, RegId::X17);
...
TEST_F(Fcnvt_b16_32, Edge0) {
  ...
  uint64_t v2 = rnd();
  uint64_t v3 = 0x0000000000010000;
...
TEST_F(Fcnvt_b16_32, Edge1) {
  ...
  uint64_t v2 = rnd();
  uint64_t v3 = 0x0000000080010000;
...
TEST_F(Fcnvt_b16_32, Edge4) {
  ...
  uint64_t v2 = rnd();
  uint64_t v3 = 0x000000007FFF0000;
...
TEST_F(Fcnvt_b16_32, Edge5) {
  ...
  uint64_t v2 = rnd();
  uint64_t v3 = 0x00000000FFFF0000;
