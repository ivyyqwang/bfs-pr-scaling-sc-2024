...
class Fcnvt_i32_32 : public ::testing::Test {
protected:
  // Setup arch state
  // push data
...
TEST_F(Fcnvt_i32_32, Random) {
  ...
  uint64_t v1 = 0x00000000FFFFFE54;
  uint64_t v2 = rnd();
  uint64_t v3 = 0x00000000C3D60000;

  inst = constrInstFcnvt(0, 7, RegId::X16, RegId::X17);
...
TEST_F(Fcnvt_i32_32, Edge0) {
  ...
  uint64_t v2 = rnd();
  uint64_t v3 = 0x000000004F000000;
...
TEST_F(Fcnvt_i32_32, Edge1) {
  ...
  std::mt19937_64 rnd(std::random_device{}());
  uint64_t v1 = 0x0000000080000000;
  uint64_t v2 = rnd();
  uint64_t v3 = 0x00000000CF000000;
