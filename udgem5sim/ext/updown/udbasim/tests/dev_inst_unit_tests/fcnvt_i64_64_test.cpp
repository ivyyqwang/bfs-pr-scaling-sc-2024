...
class Fcnvt_i64_64 : public ::testing::Test {
protected:
  // Setup arch state
  // push data
...
TEST_F(Fcnvt_i64_64, Random) {
  ...
  uint64_t v1 = 0x00036A0000000000;
  uint64_t v2 = rnd();
  uint64_t v3 = 0x430B500000000000;

  inst = constrInstFcnvt(0, 6, RegId::X16, RegId::X17);
...
TEST_F(Fcnvt_i64_64, Edge1) {
  ...
  uint64_t v2 = rnd();
  uint64_t v3 = 0xC3E0000000000000;
