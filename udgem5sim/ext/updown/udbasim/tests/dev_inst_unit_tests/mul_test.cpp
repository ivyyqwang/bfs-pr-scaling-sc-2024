...
TEST_F(Mul, Random) {
  ...
  inst = constrInstAddSubMulDivMod(2, RegId::X16, RegId::X17, RegId::X18);
  ...
  //  read_reg() == reg + imm
  EXPECT_EQ(thread0->readReg(RegId::X18), v1 * v2);
...
TEST_F(Mul, Bounded) {
  ...
  std::mt19937_64 rnd(std::random_device{}());
  uint64_t v1 = static_cast<uint64_t>((static_cast<int64_t>(rnd() << 36)) >> 36);
  uint64_t v2 = static_cast<uint64_t>((static_cast<int64_t>(rnd() << 36)) >> 36);
  uint64_t v3 = rnd();
  ...
  // std::cout << "Cycles:" << cycle << std::endl;
  //  read_reg() == reg + imm
  EXPECT_EQ(thread0->readReg(RegId::X18), static_cast<uint64_t>((static_cast<int64_t>(v2)) * (static_cast<int64_t>(v1))));
  EXPECT_EQ(thread0->readReg(RegId::X16), v1);
  EXPECT_EQ(thread0->readReg(RegId::X17), v2);
  EXPECT_EQ(cycle, basim::Cycles(1));
  // Expect to be empty.
...
TEST_F(Mul, PosPos) {
  ...
  std::mt19937_64 rnd(std::random_device{}());
  uint64_t v1 = static_cast<uint64_t>((static_cast<int64_t>((rnd() << 36) & 0x7FFFFFFFFFFFFFFF)) >> 36);
  uint64_t v2 = static_cast<uint64_t>((static_cast<int64_t>((rnd() << 36) & 0x7FFFFFFFFFFFFFFF)) >> 36);
  uint64_t v3 = rnd();
...
TEST_F(Mul, PosNeg) {
  ...
  std::mt19937_64 rnd(std::random_device{}());
  uint64_t v1 = static_cast<uint64_t>((static_cast<int64_t>((rnd() << 36) & 0x7FFFFFFFFFFFFFFF)) >> 36);
  uint64_t v2 = static_cast<uint64_t>((static_cast<int64_t>((rnd() << 36) | 0x8000000000000000)) >> 36);
  uint64_t v3 = rnd();
...
TEST_F(Mul, NegPos) {
  ...
  std::mt19937_64 rnd(std::random_device{}());
  uint64_t v1 = static_cast<uint64_t>((static_cast<int64_t>((rnd() << 36) | 0x8000000000000000)) >> 36);
  uint64_t v2 = static_cast<uint64_t>((static_cast<int64_t>((rnd() << 36) & 0x7FFFFFFFFFFFFFFF)) >> 36);
  uint64_t v3 = rnd();
