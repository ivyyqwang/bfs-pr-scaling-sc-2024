...
class Muli : public ::testing::Test {
protected:
  // Setup arch state
  // push data
...
TEST_F(Muli, Random) {
  ...
  inst = constrInstMuli(RegId::X16, RegId::X17, v1 & 0x000000000000FFFF);
...
TEST_F(Muli, Bounded) {
  ...
  std::mt19937_64 rnd(std::random_device{}());
  uint64_t v1 = static_cast<uint64_t>((static_cast<int64_t>(rnd() << 48)) >> 48);
  uint64_t v2 = static_cast<uint64_t>((static_cast<int64_t>(rnd() << 32)) >> 32);
  uint64_t v3 = rnd();
...
TEST_F(Muli, PosPos) {
  ...
  uint64_t v2 = static_cast<uint64_t>((static_cast<int64_t>((rnd() << 32) & 0x7FFFFFFFFFFFFFFF)) >> 32);
  uint64_t v3 = rnd();
...
TEST_F(Muli, NegPos) {
  ...
  std::mt19937_64 rnd(std::random_device{}());
  uint64_t v1 = static_cast<uint64_t>((static_cast<int64_t>((rnd() << 48) & 0x7FFFFFFFFFFFFFFF)) >> 48);
  uint64_t v2 = static_cast<uint64_t>((static_cast<int64_t>((rnd() << 32) | 0x8000000000000000)) >> 32);
  uint64_t v3 = rnd();
