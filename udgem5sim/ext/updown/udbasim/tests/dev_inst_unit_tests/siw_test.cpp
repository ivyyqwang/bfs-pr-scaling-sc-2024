...
TEST_F(Siw, HighValue) {
  ...
  std::mt19937_64 rnd(std::random_device{}());
  uint64_t v1 = 0x000000000000000F;
  uint64_t v2 = thread0->readReg(RegId::X4);
