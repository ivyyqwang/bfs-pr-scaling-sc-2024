...
TEST_F(Srorii, RandomLeft) {
  ...
  inst = constrInstSrorii(RegId::X16, RegId::X17, static_cast<uint8_t>(shift) & 0xF, v1);
...
TEST_F(Srorii, SignedLowerBoundShiftOne) {
  ThreadStatePtr thread0;
  uint8_t tid0 = tstable->getTID();
  thread0 = new ThreadState(tid0, 0, 0, 0);
  tstable->addtoTST(thread0);
...
TEST_F(Srorii, SignedUpperBoundShiftOne) {
  ThreadStatePtr thread0;
  uint8_t tid0 = tstable->getTID();
  thread0 = new ThreadState(tid0, 0, 0, 0);
  tstable->addtoTST(thread0);
...
TEST_F(Srorii, UnsignedLowerBoundShiftOne) {
  ThreadStatePtr thread0;
  uint8_t tid0 = tstable->getTID();
  thread0 = new ThreadState(tid0, 0, 0, 0);
  tstable->addtoTST(thread0);
...
TEST_F(Srorii, UnsignedUpperBoundShiftOne) {
  ThreadStatePtr thread0;
  uint8_t tid0 = tstable->getTID();
  thread0 = new ThreadState(tid0, 0, 0, 0);
  tstable->addtoTST(thread0);
