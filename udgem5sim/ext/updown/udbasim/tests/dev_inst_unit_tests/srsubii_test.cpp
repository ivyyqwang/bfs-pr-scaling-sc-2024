...
class Srsubii : public ::testing::Test {
protected:
  // Setup arch state
  // push data
...
TEST_F(Srsubii, RandomLeft) {
  ...
  inst = constrInstSrsubii(RegId::X16, RegId::X17, static_cast<uint8_t>(shift) & 0xF, v1);
...
TEST_F(Srsubii, SignedLowerBoundShiftOne) {
  ThreadStatePtr thread0;
  uint8_t tid0 = tstable->getTID();
  thread0 = new ThreadState(tid0, 0, 0, 0);
  tstable->addtoTST(thread0);
...
TEST_F(Srsubii, SignedUpperBoundShiftOne) {
  ThreadStatePtr thread0;
  uint8_t tid0 = tstable->getTID();
  thread0 = new ThreadState(tid0, 0, 0, 0);
  tstable->addtoTST(thread0);
...
TEST_F(Srsubii, UnsignedLowerBoundShiftOne) {
  ThreadStatePtr thread0;
  uint8_t tid0 = tstable->getTID();
  thread0 = new ThreadState(tid0, 0, 0, 0);
  tstable->addtoTST(thread0);
...
TEST_F(Srsubii, UnsignedUpperBoundShiftOne) {
  ThreadStatePtr thread0;
  uint8_t tid0 = tstable->getTID();
  thread0 = new ThreadState(tid0, 0, 0, 0);
  tstable->addtoTST(thread0);
