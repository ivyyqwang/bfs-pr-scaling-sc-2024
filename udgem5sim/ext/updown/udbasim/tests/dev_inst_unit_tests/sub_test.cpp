...
TEST_F(Sub, Random) {
  ...
  inst = constrInstAddSubMulDivMod(1, RegId::X16, RegId::X17, RegId::X18);
...
TEST_F(Sub, SignedUpperBound) {
  ...
  int64_t v2 = rnd() | 0x8000000000000000;
  int64_t v3 = rnd();
