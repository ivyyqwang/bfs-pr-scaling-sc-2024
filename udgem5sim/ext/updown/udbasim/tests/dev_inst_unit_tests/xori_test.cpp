...
TEST_F(Xori, Random) {
  ...
  inst = constrInstXori(RegId::X16, RegId::X17, v2 & 0x000000000000FFFF);
  ...
  //  read_reg() == reg + imm
  EXPECT_EQ(thread0->readReg(RegId::X17), static_cast<int64_t>(v1) ^ static_cast<uint64_t>(v2 & 0x000000000000FFFF));
