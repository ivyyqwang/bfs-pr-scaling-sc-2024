...
#include "sht_concurrency_test_out.hpp"
...
#else
  // auto *rt = new UpDown::SimUDRuntime_t(machine, "sht_test", "SHTExampleEFA", "./");
  // auto *rt = new UpDown::SimUDRuntime_t(machine, "sht_test", "SHTFuncLiteTestEFA", "./");
  auto *rt = new UpDown::SimUDRuntime_t(machine, "sht_concurrency_test_out", "main", "./");
